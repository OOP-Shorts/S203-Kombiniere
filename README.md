In dieser Aufgabe beschäftigst du dich mit Arrays. In dieser Aufgabe werden zwei Arrays verwendet, um jeweils zwei Werte aus beiden zu multiplzieren und das Ergebnis auf der Konsole auszugeben.
